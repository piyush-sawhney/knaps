...
def update_po_investment_in_rd_account() -> None:
    rd_accounts = frappe.get_all(
        "KNAPS RD Account", filters={"po_rd_investment": None}, pluck="name"
    )
    for rd_account in rd_accounts:
        ...
        if po_investment:
            ...
            try:
                ...
                message = _(f"RD Account {rd_account} and PO Investment {po_investment} have {e}")
